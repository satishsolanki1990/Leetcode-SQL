...
In this case, Count the total accepted requests (no matter whether they are 
in the original requests), and divide it by the number of requests to get the acceptance rate.
...
https://leetcode.com/study-plan/sql/?progress=jnbospg
*/
